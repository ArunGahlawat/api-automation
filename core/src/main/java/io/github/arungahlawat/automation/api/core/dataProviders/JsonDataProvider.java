...
import io.github.arungahlawat.automation.api.core.utils.io.impl.readers.JsonReader;
...
public class JsonDataProvider {
    ...
    public <T> Iterator<T> getProvider(GsonBuilder gsonBuilder, String filePath) {
        ...
        List<T> rowData = gson.fromJson(jsonElement, new TypeToken<List<T>>() {}.getType());
